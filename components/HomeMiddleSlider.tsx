...
const HomeMiddleSlider = () => {
  ...
  const parseBannerText = (text: string) => {
    ...
    return (
      <>
        {spans[0] && <span className="text-xl 2xl:text-[60px] md:text-[45px] text-[40px] text-center leading-none tracking-wide font-gilroy-extrabold">{spans[0].textContent}</span>}
        {spans[1] && <span className="text-xl 2xl:text-[60px] md:text-[45px] text-[40px] text-center leading-none tracking-wide font-gilroy-extrabold">{spans[1].textContent}</span>}
        {spans[2] && <span className="text-primaryText text-xl 2xl:text-[45px] md:text-[50px] text-[40px] text-center leading-none tracking-wide font-gilroy-extrabold">{spans[2].textContent}</span>}
