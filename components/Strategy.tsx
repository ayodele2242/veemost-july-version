    ...
    style={{ 
      ...
      <div className="md:m-[4rem] m-[1rem] md:pt-0 pt-[4rem] xl:m-0">
            <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
               <div className="flex flex-col lg:w-[528px]">
                  <div className="lg:w-[415px]">
                     <h2 className="text-[#0B0B0C] font-GilroySemiBold font-normal text-[32px] md:text-[40px] text-center lg:text-left">Strategy &amp; <span className="text-[#D6A912]">Consultation</span></h2>
                  </div>
